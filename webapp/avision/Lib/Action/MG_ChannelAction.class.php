...
//dump($webVar);
        ...
        $attrib=array(
            ...
            array("key"=>"chatReview", "name"=>"1-聊天信息审核后发布, 0-直接发布", "gkey"=>"", "group"=>"其它参数", "value"=>"0", "editor"=>array("type"=>"numberspinner","options"=>array("min"=>0,"max"=>1))),
            array("key"=>"hiddenLeftTime", "name"=>"隐藏开播倒计时及信号状态[0|1]", "gkey"=>"", "group"=>"其它参数", "value"=>"0", "editor"=>array("type"=>"numberspinner","options"=>array("min"=>0,"max"=>1)))
        );
