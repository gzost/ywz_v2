 ...
 * file(s).
 * 2017-04-09 修改handleUpload,combineChunks使之适应使用需要
 */
...
class UploadHandler {
	...
	public $useUuid=true;	//若设成false，上传目标文件目录不包括UUID	2017-04-09 outao
    /**
    ...
    /**
     * Process the upload.
     * 如果没定义$this->useUuid=true文件存储在：$uploadDirectory/$uuid/$name
     * 否则存储在$uploadDirectory/$name
     * @param string $uploadDirectory Target directory.
     * @param string $name Overwrites the name of the file.
     * @param bool $useUuid 文件存储路径是否使用UUID
     */
