...
CLASS WXHongBao {
  ...
  private $mch_id = "1352453202";//商户ID写死
  private $wxappid = "wx4d643706467f58b0";//微信公众号，写死
  private $client_ip = "58.67.171.56"; //调用红包接口的主机的IP,服务端IP,写死，即脚本文件所在的IP
  private $apikey = "uKUxYWgoLExCem4EFRKuMEGsJzZwjNJO";//pay的秘钥值
  ...
  private $nonce_str = '';
  private $mch_billno = '';
  private $re_openid = "oiOoGwTFTwfY_MZTChevdIxrPjZk";//接收方的openID  
  ...
  function __construct(){
	...
	echo $this->apiclient_key;
	echo $this->apiclient_cert;

	$this->nonce_str = substr(microtime(), 2, 6);
	$this->mch_billno = date('YmdHis', time()).substr(microtime(), 2, 6);
  }
