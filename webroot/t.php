...
class a{
    ...
    public function onRecv($obj,$func,$para){
        $this->obj=$obj;
        $this->func=$func;
        $this->para=$para;
    }
...
class b   extends a implements f1{
    ...
    public function cc(){
        echo "b->cc<br>";
        $c= new a;
        $c->onRecv($this,'d',array('555'));
        $ss=uniqid();
        call_user_func(array($c,'show'),$ss);
...
$b=$this->decode($buffer);
//echo "data=".$b." tm=".microtime()."\n";
printf("data=%s tm=%s\n",$b,microtime());
    ...
    function decode($buffer)
     {
         ...
         if ($len === 126)  {
             ...
             $dataLen=ord($buffer[2])<<8 +ord($buffer[3]);
...
echo "playload len:".$dataLen."\n";
    ...
    function WebSocket($address,$port){
        ...
        $this->e('Server Started 1: '.date('Y-m-d H:i:s'));
